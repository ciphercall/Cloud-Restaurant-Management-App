    ...
    public class ASL_MENUController : Controller
    {
        ...
        public ActionResult IndexPost(PageModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = db.AslMenumstDbSet.Count(d => d.MODULENM == model.aslMenumst.MODULENM && d.MODULEID == model.aslMenumst.MODULEID);
                if (result == 0)
                {
                    ...
                    if (id == null)
                    {
                        ...
                        TempData["message"] = "Module Name: '" + model.aslMenumst.MODULENM + "' successfully saved.\n Please Create the Menu List.";
        ...
        public string Edit(string ModId, string MenuType, ASL_MENU objTodo)
        {
            ...
            try
            {
                ...
                var qrM = from b in db.AslRoleDbSet where b.MENUID == objTodo.MENUID select b;
        ...
        public string Delete(int Id)
        {
            ...
            var companAllInfo = from role in db.AslRoleDbSet where role.MODULEID == todolist.MODULEID && role.MENUID==todolist.MENUID 
                                    && role.MENUTP==todolist.MENUTP select role;

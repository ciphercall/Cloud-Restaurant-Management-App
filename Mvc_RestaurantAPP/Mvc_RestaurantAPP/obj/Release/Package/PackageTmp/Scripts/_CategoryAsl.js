$(function () {
    ...
    $("#categorygrid").jqGrid({
        ...
        datatype: 'json',
        mtype: 'Get',
        colNames: ['Action', 'RMS_ITEMid', 'CompanyId', 'CategoryId', 'ItemId', 'Item Name', 'Brand', 'Unit', 'Buy Rate ', 'SaleRate', 'Stock Minimum', 'Discount', 'Remarks', 'UPDLTUDE'],
        colModel: [
          {
              name: "Edit Actions",
              width: 30,
            ...
            //displayed Columns
            { key: false, name: 'ITEMID', index: 'ITEMID', editoptions: { readonly: "readonly" }, editable: true, width: 50 },
            { key: false, name: 'ITEMNM', index: 'ITEMNM', editable: true, width: 50 },
            { key: false, name: 'BRAND', index: 'BRAND', editable: true, width: 50 },
            { key: false, name: 'UNIT', index: 'UNIT', editable: true, width: 50 },
            {
                key: false, name: 'BUYRT', index: 'BUYRT', editable: true, width: 50, edittype: "text", editoptions: {
            ...
            {
                key: false, name: 'SALRT', index: 'SALRT', editable: true, width: 50, edittype: "text", editoptions: {
                    dataInit: function (element) {
                        $(element).keyup(function () {
                            var val1 = element.value;
                            var num = new Number(val1);
            ...
            {
                key: false, name: 'STKMIN', index: 'STKMIN', editable: true, width: 50, edittype: "text", editoptions: {
                    dataInit: function (element) {
                        $(element).keyup(function () {
                            var val1 = element.value;
                            var num = new Number(val1);
            ...
            {
                key: false, name: 'DISCOUNT', index: 'DISCOUNT', editable: true, width: 50, edittype: "text", editoptions: {
                    dataInit: function (element) {
                        $(element).keyup(function () {
                            var val1 = element.value;
                            var num = new Number(val1);
            ...
            {key: false, hidden: true,name: 'UPDLTUDE', index: 'UPDLTUDE', editable: true, width: 50}],
        pager: jQuery('#pager'),
        onSelectRow: editRow,
        rowNum: 15,
        rowList: [15, 20, 30, 40],
